        ...
        <v-col cols="12" class="d-lg-none">
          <v-card color="#53566B" width="100%" elevation="4" class="pa-5">
            ...
            <div class="pa-3">
              ...
              <v-text-field variant="outlined" hint="write" v-model="game"></v-text-field>


              <v-expansion-panels class="mb-3">
                <v-expansion-panel color="#21232B" title="Game Modes" text="Pick Game Mode to play."></v-expansion-panel>
              </v-expansion-panels>
              <v-text-field :disabled="true" v-model="gamename" variant="outlined" hint="what gamemode you want to play" ></v-text-field>
            ...
            <div class="d-flex justify-space-between">
              ...
              <v-btn class="ma-2" color="blue" @click="createRoom">Create</v-btn>
            </div>
          </v-card>
        </v-col>
        ...
        <v-col cols="12" lg="49" xl="4" class="d-none d-lg-flex justify-center">
          <v-card color="#53566B" width="100%" elevation="4" class="pa-5">
            ...
            <div class="pa-3">
              ...
              <v-text-field  variant="outlined" hint="write" v-model="roomName"></v-text-field>


              <v-expansion-panels class="mb-3">
                <v-expansion-panel color="#21232B"  title="Game Modes" text="Game mode you picked to play."></v-expansion-panel>
              </v-expansion-panels>
              <v-text-field :disabled="true" v-model="gamename" variant="outlined"  ></v-text-field>
            ...
            <div class="d-flex justify-space-between">
              <v-btn @click="CancelCreatingRoom" class="ma-2" color="red">Cancel</v-btn>
              <v-btn @click="createRoom" class="ma-2" color="blue">Create</v-btn>
            </div>
          </v-card>
        </v-col>
      </v-row>
  ...
  export default {
    ...
    methods: {
      ...
      checkIfNameAlreadyUsed(roomName) {
        axios.get('https://backendbombgane.onrender.com/api/room/fetch-rooms')
            .then(async (response) => {
